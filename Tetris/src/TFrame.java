			...
			case(MANUAL): {
				switch(e.getKeyCode()) {
					...
					case(KeyEvent.VK_DOWN): {
						...
						s.clearNext();
						s.drawNext(slot, orient);
						System.out.println("ah: " + s.getAggregateHeights() + " b: " + s.getBumpiness() + " h: " + s.getNumberOfHoles() + " cl: "+ s.getRowsCleared()+ " blockades: " + s.getNumberOfBlockades() + " Touching floor: " + s.getNumberOfEdgesTouchingFloor());
						break;
					}
					default:
						break;
